...
galaxyGeometry.setAttribute(
  "position", new THREE.BufferAttribute(galaxyPosition, 3)
)
galaxyGeometry.setAttribute(
  "size", new THREE.BufferAttribute(galaxySize, 1)
)
galaxyGeometry.setAttribute(
  "seed", new THREE.BufferAttribute(galaxySeed, 3)
)



const innColor = new THREE.Color("#00ff2a")
const outColor = new THREE.Color("#fdff75")
...
universeGeometry.setAttribute(
  "position", new THREE.BufferAttribute(universePosition, 3)
)
universeGeometry.setAttribute(
  "seed", new THREE.BufferAttribute(universeSeed, 3)
)
universeGeometry.setAttribute(
  "size", new THREE.BufferAttribute(universeSize, 1)
)
...
vec3 scatter (vec3 seed) {
  ...
  return vec3(x, y, z);
    ...
    return ( 
        <div>
        <canvas className="webgl" id="canvas">Your browser does not support WebGL</canvas>
      </div> );
}
